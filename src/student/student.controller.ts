...
export class StudentController {
  ...
  async downloadTemplate(@Res() res) {
    ...
    const sampleRows = [
      ...
      { firstName: 'John', lastName: 'Doe', password: 'Password123!', email: 'stu001@edunexus.test', username: 'stu001', phoneNumber: '265990000001', address: '123 Main St', dateOfBirth: '2012-05-14', gender: 'Male', gradeLevel: 'Form 1', class: 'Form one', parentId: '', studentId: 'STU001' },
      { firstName: 'Grace', lastName: 'Wanjiru', password: 'Password123!', email: 'stu002@edunexus.test', username: 'stu002', phoneNumber: '265990000002', address: 'Mzuzu', dateOfBirth: '2012-11-23', gender: 'Female', gradeLevel: 'Form 1', class: 'Form one', parentId: '', studentId: 'STU002' },
      { firstName: 'Brian', lastName: 'Mwangi', password: 'Password123!', email: 'stu003@edunexus.test', username: 'stu003', phoneNumber: '265990000003', address: 'Zomba', dateOfBirth: '2012-09-30', gender: 'Male', gradeLevel: 'Form 1', class: 'Form one', parentId: '', studentId: 'STU003' },
      { firstName: 'Naomi', lastName: 'Chebet', password: 'Password123!', email: 'stu004@edunexus.test', username: 'stu004', phoneNumber: '265990000004', address: 'Kasungu', dateOfBirth: '2012-04-08', gender: 'Female', gradeLevel: 'Form 1', class: 'Form one', parentId: '', studentId: 'STU004' },
      { firstName: 'Kevin', lastName: 'Mutua', password: 'Password123!', email: 'stu005@edunexus.test', username: 'stu005', phoneNumber: '265990000005', address: 'Mangochi', dateOfBirth: '2012-07-19', gender: 'Male', gradeLevel: 'Form 1', class: 'Form one', parentId: '', studentId: 'STU005' },
      { firstName: 'Sarah', lastName: 'Waweru', password: 'Password123!', email: 'stu006@edunexus.test', username: 'stu006', phoneNumber: '265990000006', address: 'Salima', dateOfBirth: '2012-03-15', gender: 'Female', gradeLevel: 'Form 1', class: 'Form one', parentId: '', studentId: 'STU006' },
      { firstName: 'David', lastName: 'Ochieng', password: 'Password123!', email: 'stu007@edunexus.test', username: 'stu007', phoneNumber: '265990000007', address: 'Karonga', dateOfBirth: '2012-10-02', gender: 'Male', gradeLevel: 'Form 1', class: 'Form one', parentId: '', studentId: 'STU007' },
      { firstName: 'Lucy', lastName: 'Nyong', password: 'Password123!', email: 'stu008@edunexus.test', username: 'stu008', phoneNumber: '265990000008', address: 'Dedza', dateOfBirth: '2012-06-27', gender: 'Female', gradeLevel: 'Form 1', class: 'Form one', parentId: '', studentId: 'STU008' },

      // Form 2 Students (8 students)
      { firstName: 'Mary', lastName: 'Kamau', password: 'Password123!', email: 'stu009@edunexus.test', username: 'stu009', phoneNumber: '265990000009', address: 'Lilongwe', dateOfBirth: '2011-09-01', gender: 'Female', gradeLevel: 'Form 2', class: 'Form two', parentId: '', studentId: 'STU009' },
      { firstName: 'Peter', lastName: 'Otieno', password: 'Password123!', email: 'stu010@edunexus.test', username: 'stu010', phoneNumber: '265990000010', address: 'Blantyre', dateOfBirth: '2011-03-05', gender: 'Male', gradeLevel: 'Form 2', class: 'Form two', parentId: '', studentId: 'STU010' },
      { firstName: 'Faith', lastName: 'Njeri', password: 'Password123!', email: 'stu011@edunexus.test', username: 'stu011', phoneNumber: '265990000011', address: 'Mzimba', dateOfBirth: '2011-12-12', gender: 'Female', gradeLevel: 'Form 2', class: 'Form two', parentId: '', studentId: 'STU011' },
      { firstName: 'Michael', lastName: 'Kiprop', password: 'Password123!', email: 'stu012@edunexus.test', username: 'stu012', phoneNumber: '265990000012', address: 'Balaka', dateOfBirth: '2011-08-18', gender: 'Male', gradeLevel: 'Form 2', class: 'Form two', parentId: '', studentId: 'STU012' },
      { firstName: 'Joyce', lastName: 'Waithera', password: 'Password123!', email: 'stu013@edunexus.test', username: 'stu013', phoneNumber: '265990000013', address: 'Ntcheu', dateOfBirth: '2011-04-25', gender: 'Female', gradeLevel: 'Form 2', class: 'Form two', parentId: '', studentId: 'STU013' },
      { firstName: 'James', lastName: 'Koech', password: 'Password123!', email: 'stu014@edunexus.test', username: 'stu014', phoneNumber: '265990000014', address: 'Chikwawa', dateOfBirth: '2011-11-09', gender: 'Male', gradeLevel: 'Form 2', class: 'Form two', parentId: '', studentId: 'STU014' },
      { firstName: 'Alice', lastName: 'Muthoni', password: 'Password123!', email: 'stu015@edunexus.test', username: 'stu015', phoneNumber: '265990000015', address: 'Machinga', dateOfBirth: '2011-01-14', gender: 'Female', gradeLevel: 'Form 2', class: 'Form two', parentId: '', studentId: 'STU015' },
      { firstName: 'Emmanuel', lastName: 'Wekesa', password: 'Password123!', email: 'stu016@edunexus.test', username: 'stu016', phoneNumber: '265990000016', address: 'Rumphi', dateOfBirth: '2011-06-30', gender: 'Male', gradeLevel: 'Form 2', class: 'Form two', parentId: '', studentId: 'STU016' },

      // Form 3 Students (8 students)
      { firstName: 'Ali', lastName: 'Hassan', password: 'Password123!', email: 'stu017@edunexus.test', username: 'stu017', phoneNumber: '265990000017', address: 'Nkhata Bay', dateOfBirth: '2010-02-10', gender: 'Male', gradeLevel: 'Form 3', class: 'Form Three', parentId: '', studentId: 'STU017' },
      { firstName: 'Linda', lastName: 'Achieng', password: 'Password123!', email: 'stu018@edunexus.test', username: 'stu018', phoneNumber: '265990000018', address: 'Nkhotakota', dateOfBirth: '2010-07-18', gender: 'Female', gradeLevel: 'Form 3', class: 'Form Three', parentId: '', studentId: 'STU018' },
      { firstName: 'Samuel', lastName: 'Kibet', password: 'Password123!', email: 'stu019@edunexus.test', username: 'stu019', phoneNumber: '265990000019', address: 'Mulanje', dateOfBirth: '2010-01-22', gender: 'Male', gradeLevel: 'Form 3', class: 'Form Three', parentId: '', studentId: 'STU019' },
      { firstName: 'Mercy', lastName: 'Wanjiku', password: 'Password123!', email: 'stu020@edunexus.test', username: 'stu020', phoneNumber: '265990000020', address: 'Nsanje', dateOfBirth: '2010-09-16', gender: 'Female', gradeLevel: 'Form 3', class: 'Form Three', parentId: '', studentId: 'STU020' },
      { firstName: 'Victor', lastName: 'Mutiso', password: 'Password123!', email: 'stu021@edunexus.test', username: 'stu021', phoneNumber: '265990000021', address: 'Phalombe', dateOfBirth: '2010-05-12', gender: 'Male', gradeLevel: 'Form 3', class: 'Form Three', parentId: '', studentId: 'STU021' },
      { firstName: 'Rose', lastName: 'Adhiambo', password: 'Password123!', email: 'stu022@edunexus.test', username: 'stu022', phoneNumber: '265990000022', address: 'Likoma', dateOfBirth: '2010-12-07', gender: 'Female', gradeLevel: 'Form 3', class: 'Form Three', parentId: '', studentId: 'STU022' },
      { firstName: 'Daniel', lastName: 'Kiptoo', password: 'Password123!', email: 'stu023@edunexus.test', username: 'stu023', phoneNumber: '265990000023', address: 'Dowa', dateOfBirth: '2010-03-28', gender: 'Male', gradeLevel: 'Form 3', class: 'Form Three', parentId: '', studentId: 'STU023' },
      { firstName: 'Esther', lastName: 'Nyambura', password: 'Password123!', email: 'stu024@edunexus.test', username: 'stu024', phoneNumber: '265990000024', address: 'Neno', dateOfBirth: '2010-08-13', gender: 'Female', gradeLevel: 'Form 3', class: 'Form Three', parentId: '', studentId: 'STU024' },

      // Form 4 Students (8 students)
      { firstName: 'Collins', lastName: 'Ongeri', password: 'Password123!', email: 'stu025@edunexus.test', username: 'stu025', phoneNumber: '265990000025', address: 'Chiradzulu', dateOfBirth: '2009-04-03', gender: 'Male', gradeLevel: 'Form 4', class: 'Form Four', parentId: '', studentId: 'STU025' },
      { firstName: 'Catherine', lastName: 'Wambui', password: 'Password123!', email: 'stu026@edunexus.test', username: 'stu026', phoneNumber: '265990000026', address: 'Mchinji', dateOfBirth: '2009-10-21', gender: 'Female', gradeLevel: 'Form 4', class: 'Form Four', parentId: '', studentId: 'STU026' },
      { firstName: 'Francis', lastName: 'Macharia', password: 'Password123!', email: 'stu027@edunexus.test', username: 'stu027', phoneNumber: '265990000027', address: 'Thyolo', dateOfBirth: '2009-01-17', gender: 'Male', gradeLevel: 'Form 4', class: 'Form Four', parentId: '', studentId: 'STU027' },
      { firstName: 'Helen', lastName: 'Nafula', password: 'Password123!', email: 'stu028@edunexus.test', username: 'stu028', phoneNumber: '265990000028', address: 'Ntchisi', dateOfBirth: '2009-07-29', gender: 'Female', gradeLevel: 'Form 4', class: 'Form Four', parentId: '', studentId: 'STU028' },
      { firstName: 'Robert', lastName: 'Kiprotich', password: 'Password123!', email: 'stu029@edunexus.test', username: 'stu029', phoneNumber: '265990000029', address: 'Chitipa', dateOfBirth: '2009-05-08', gender: 'Male', gradeLevel: 'Form 4', class: 'Form Four', parentId: '', studentId: 'STU029' },
      { firstName: 'Margaret', lastName: 'Wangari', password: 'Password123!', email: 'stu030@edunexus.test', username: 'stu030', phoneNumber: '265990000030', address: 'Chikwawa East', dateOfBirth: '2009-11-24', gender: 'Female', gradeLevel: 'Form 4', class: 'Form Four', parentId: '', studentId: 'STU030' },
      { firstName: 'Anthony', lastName: 'Ouma', password: 'Password123!', email: 'stu031@edunexus.test', username: 'stu031', phoneNumber: '265990000031', address: 'Mzimba North', dateOfBirth: '2009-02-15', gender: 'Male', gradeLevel: 'Form 4', class: 'Form Four', parentId: '', studentId: 'STU031' },
      { firstName: 'Beatrice', lastName: 'Jebet', password: 'Password123!', email: 'stu032@edunexus.test', username: 'stu032', phoneNumber: '265990000032', address: 'Nkhata Bay North', dateOfBirth: '2009-09-11', gender: 'Female', gradeLevel: 'Form 4', class: 'Form Four', parentId: '', studentId: 'STU032' }
    ];
