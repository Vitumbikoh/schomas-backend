...
export class StudentController {
  ...
  async downloadTemplate(@Res() res) {
    ...
    const sampleRows = [
      ...
      { firstName: 'John', lastName: 'Doe', password: 'Password123!', email: 'stu001@edunexus.test', username: 'stu001', phoneNumber: '254700000001', address: '123 Main St', dateOfBirth: '2012-05-14', gender: 'Male', gradeLevel: 'Form 1', class: 'Form one', parentId: '', studentId: 'STU001' },
      { firstName: 'Grace', lastName: 'Wanjiru', password: 'Password123!', email: 'stu002@edunexus.test', username: 'stu002', phoneNumber: '254700000002', address: 'Nakuru', dateOfBirth: '2012-11-23', gender: 'Female', gradeLevel: 'Form 1', class: 'Form one', parentId: '', studentId: 'STU002' },
      { firstName: 'Brian', lastName: 'Mwangi', password: 'Password123!', email: 'stu003@edunexus.test', username: 'stu003', phoneNumber: '254700000003', address: 'Thika', dateOfBirth: '2012-09-30', gender: 'Male', gradeLevel: 'Form 1', class: 'Form one', parentId: '', studentId: 'STU003' },
      { firstName: 'Naomi', lastName: 'Chebet', password: 'Password123!', email: 'stu004@edunexus.test', username: 'stu004', phoneNumber: '254700000004', address: 'Bomet', dateOfBirth: '2012-04-08', gender: 'Female', gradeLevel: 'Form 1', class: 'Form one', parentId: '', studentId: 'STU004' },
      { firstName: 'Kevin', lastName: 'Mutua', password: 'Password123!', email: 'stu005@edunexus.test', username: 'stu005', phoneNumber: '254700000005', address: 'Machakos', dateOfBirth: '2012-07-19', gender: 'Male', gradeLevel: 'Form 1', class: 'Form one', parentId: '', studentId: 'STU005' },
      { firstName: 'Sarah', lastName: 'Waweru', password: 'Password123!', email: 'stu006@edunexus.test', username: 'stu006', phoneNumber: '254700000006', address: 'Kiambu', dateOfBirth: '2012-03-15', gender: 'Female', gradeLevel: 'Form 1', class: 'Form one', parentId: '', studentId: 'STU006' },
      { firstName: 'David', lastName: 'Ochieng', password: 'Password123!', email: 'stu007@edunexus.test', username: 'stu007', phoneNumber: '254700000007', address: 'Homa Bay', dateOfBirth: '2012-10-02', gender: 'Male', gradeLevel: 'Form 1', class: 'Form one', parentId: '', studentId: 'STU007' },
      { firstName: 'Lucy', lastName: 'Nyong', password: 'Password123!', email: 'stu008@edunexus.test', username: 'stu008', phoneNumber: '254700000008', address: 'Kajiado', dateOfBirth: '2012-06-27', gender: 'Female', gradeLevel: 'Form 1', class: 'Form one', parentId: '', studentId: 'STU008' },

      // Form 2 Students (8 students)
      { firstName: 'Mary', lastName: 'Kamau', password: 'Password123!', email: 'stu009@edunexus.test', username: 'stu009', phoneNumber: '254700000009', address: 'Nairobi', dateOfBirth: '2011-09-01', gender: 'Female', gradeLevel: 'Form 2', class: 'Form two', parentId: '', studentId: 'STU009' },
      { firstName: 'Peter', lastName: 'Otieno', password: 'Password123!', email: 'stu010@edunexus.test', username: 'stu010', phoneNumber: '254700000010', address: 'Kisumu', dateOfBirth: '2011-03-05', gender: 'Male', gradeLevel: 'Form 2', class: 'Form two', parentId: '', studentId: 'STU010' },
      { firstName: 'Faith', lastName: 'Njeri', password: 'Password123!', email: 'stu011@edunexus.test', username: 'stu011', phoneNumber: '254700000011', address: 'Nyeri', dateOfBirth: '2011-12-12', gender: 'Female', gradeLevel: 'Form 2', class: 'Form two', parentId: '', studentId: 'STU011' },
      { firstName: 'Michael', lastName: 'Kiprop', password: 'Password123!', email: 'stu012@edunexus.test', username: 'stu012', phoneNumber: '254700000012', address: 'Nandi', dateOfBirth: '2011-08-18', gender: 'Male', gradeLevel: 'Form 2', class: 'Form two', parentId: '', studentId: 'STU012' },
      { firstName: 'Joyce', lastName: 'Waithera', password: 'Password123!', email: 'stu013@edunexus.test', username: 'stu013', phoneNumber: '254700000013', address: 'Murang\'a', dateOfBirth: '2011-04-25', gender: 'Female', gradeLevel: 'Form 2', class: 'Form two', parentId: '', studentId: 'STU013' },
      { firstName: 'James', lastName: 'Koech', password: 'Password123!', email: 'stu014@edunexus.test', username: 'stu014', phoneNumber: '254700000014', address: 'Uasin Gishu', dateOfBirth: '2011-11-09', gender: 'Male', gradeLevel: 'Form 2', class: 'Form two', parentId: '', studentId: 'STU014' },
      { firstName: 'Alice', lastName: 'Muthoni', password: 'Password123!', email: 'stu015@edunexus.test', username: 'stu015', phoneNumber: '254700000015', address: 'Kirinyaga', dateOfBirth: '2011-01-14', gender: 'Female', gradeLevel: 'Form 2', class: 'Form two', parentId: '', studentId: 'STU015' },
      { firstName: 'Emmanuel', lastName: 'Wekesa', password: 'Password123!', email: 'stu016@edunexus.test', username: 'stu016', phoneNumber: '254700000016', address: 'Bungoma', dateOfBirth: '2011-06-30', gender: 'Male', gradeLevel: 'Form 2', class: 'Form two', parentId: '', studentId: 'STU016' },

      // Form 3 Students (8 students)
      { firstName: 'Ali', lastName: 'Hassan', password: 'Password123!', email: 'stu017@edunexus.test', username: 'stu017', phoneNumber: '254700000017', address: 'Mombasa', dateOfBirth: '2010-02-10', gender: 'Male', gradeLevel: 'Form 3', class: 'Form Three', parentId: '', studentId: 'STU017' },
      { firstName: 'Linda', lastName: 'Achieng', password: 'Password123!', email: 'stu018@edunexus.test', username: 'stu018', phoneNumber: '254700000018', address: 'Eldoret', dateOfBirth: '2010-07-18', gender: 'Female', gradeLevel: 'Form 3', class: 'Form Three', parentId: '', studentId: 'STU018' },
      { firstName: 'Samuel', lastName: 'Kibet', password: 'Password123!', email: 'stu019@edunexus.test', username: 'stu019', phoneNumber: '254700000019', address: 'Kericho', dateOfBirth: '2010-01-22', gender: 'Male', gradeLevel: 'Form 3', class: 'Form Three', parentId: '', studentId: 'STU019' },
      { firstName: 'Mercy', lastName: 'Wanjiku', password: 'Password123!', email: 'stu020@edunexus.test', username: 'stu020', phoneNumber: '254700000020', address: 'Embu', dateOfBirth: '2010-09-16', gender: 'Female', gradeLevel: 'Form 3', class: 'Form Three', parentId: '', studentId: 'STU020' },
      { firstName: 'Victor', lastName: 'Mutiso', password: 'Password123!', email: 'stu021@edunexus.test', username: 'stu021', phoneNumber: '254700000021', address: 'Kitui', dateOfBirth: '2010-05-12', gender: 'Male', gradeLevel: 'Form 3', class: 'Form Three', parentId: '', studentId: 'STU021' },
      { firstName: 'Rose', lastName: 'Adhiambo', password: 'Password123!', email: 'stu022@edunexus.test', username: 'stu022', phoneNumber: '254700000022', address: 'Siaya', dateOfBirth: '2010-12-07', gender: 'Female', gradeLevel: 'Form 3', class: 'Form Three', parentId: '', studentId: 'STU022' },
      { firstName: 'Daniel', lastName: 'Kiptoo', password: 'Password123!', email: 'stu023@edunexus.test', username: 'stu023', phoneNumber: '254700000023', address: 'Baringo', dateOfBirth: '2010-03-28', gender: 'Male', gradeLevel: 'Form 3', class: 'Form Three', parentId: '', studentId: 'STU023' },
      { firstName: 'Esther', lastName: 'Nyambura', password: 'Password123!', email: 'stu024@edunexus.test', username: 'stu024', phoneNumber: '254700000024', address: 'Nyandarua', dateOfBirth: '2010-08-13', gender: 'Female', gradeLevel: 'Form 3', class: 'Form Three', parentId: '', studentId: 'STU024' },

      // Form 4 Students (8 students)
      { firstName: 'Collins', lastName: 'Ongeri', password: 'Password123!', email: 'stu025@edunexus.test', username: 'stu025', phoneNumber: '254700000025', address: 'Kisii', dateOfBirth: '2009-04-03', gender: 'Male', gradeLevel: 'Form 4', class: 'Form Four', parentId: '', studentId: 'STU025' },
      { firstName: 'Catherine', lastName: 'Wambui', password: 'Password123!', email: 'stu026@edunexus.test', username: 'stu026', phoneNumber: '254700000026', address: 'Laikipia', dateOfBirth: '2009-10-21', gender: 'Female', gradeLevel: 'Form 4', class: 'Form Four', parentId: '', studentId: 'STU026' },
      { firstName: 'Francis', lastName: 'Macharia', password: 'Password123!', email: 'stu027@edunexus.test', username: 'stu027', phoneNumber: '254700000027', address: 'Meru', dateOfBirth: '2009-01-17', gender: 'Male', gradeLevel: 'Form 4', class: 'Form Four', parentId: '', studentId: 'STU027' },
      { firstName: 'Helen', lastName: 'Nafula', password: 'Password123!', email: 'stu028@edunexus.test', username: 'stu028', phoneNumber: '254700000028', address: 'Kakamega', dateOfBirth: '2009-07-29', gender: 'Female', gradeLevel: 'Form 4', class: 'Form Four', parentId: '', studentId: 'STU028' },
      { firstName: 'Robert', lastName: 'Kiprotich', password: 'Password123!', email: 'stu029@edunexus.test', username: 'stu029', phoneNumber: '254700000029', address: 'Elgeyo Marakwet', dateOfBirth: '2009-05-08', gender: 'Male', gradeLevel: 'Form 4', class: 'Form Four', parentId: '', studentId: 'STU029' },
      { firstName: 'Margaret', lastName: 'Wangari', password: 'Password123!', email: 'stu030@edunexus.test', username: 'stu030', phoneNumber: '254700000030', address: 'Tharaka Nithi', dateOfBirth: '2009-11-24', gender: 'Female', gradeLevel: 'Form 4', class: 'Form Four', parentId: '', studentId: 'STU030' },
      { firstName: 'Anthony', lastName: 'Ouma', password: 'Password123!', email: 'stu031@edunexus.test', username: 'stu031', phoneNumber: '254700000031', address: 'Migori', dateOfBirth: '2009-02-15', gender: 'Male', gradeLevel: 'Form 4', class: 'Form Four', parentId: '', studentId: 'STU031' },
      { firstName: 'Beatrice', lastName: 'Jebet', password: 'Password123!', email: 'stu032@edunexus.test', username: 'stu032', phoneNumber: '254700000032', address: 'West Pokot', dateOfBirth: '2009-09-11', gender: 'Female', gradeLevel: 'Form 4', class: 'Form Four', parentId: '', studentId: 'STU032' }
    ];
